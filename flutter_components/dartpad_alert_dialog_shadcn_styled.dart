        ...
        builder: (context, child) => FadeTransition(
          ...
          child: ScaleTransition(
            ...
            child: Dialog(
              ...
              elevation: 24,
              shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(8), // shadcn/ui: 8px
                side: BorderSide(
              ...
              child: ConstrainedBox(
                ...
                child: Padding(
                  padding: const EdgeInsets.all(24), // shadcn/ui: 24px
                  child: Column(
